...
<body>
		...
		<div id="menuCenter">
			<div id="nav">
				<ul>
					...
					<li><a  style="color:#66CCCC" href="contactenos.jsp">CONTACTENOS</a></li>
	...
	<div id="contenido">
		<div id="contenido-cont">
			<h2 class="ti">Contactenos</h2>
	    	<p class="pa"><br>-Somos una Clinica en crecimiento, no somo perfectos, si tuviera una sugerencia, reclamo, duda, etc.<br>
	    	Envienos su opinion llenando el formulario de abajo</p>
			<div class="entrada">
				<div class="tituloEntrada">CORREO</div>
				<div class="cuerpoEntrada">
					<div id="centrarForm">
						<form action="enviarComentario" method="get">
							<span class="lf">Ingrese su Correo</span> 
							<input type="email" name="email"placeHolder="Ejemplo: usuario@gmail.com">
							<span class="lf">Ingrese Contenido</span> 
							<textarea name="contenido" placeHolder="Aqui aqui su opnion" rows="4" cols="50"></textarea>
							<br><input type="submit" class="enviar" value="ENVIAR">
						</form>
					</div>
				</div>
			</div>
