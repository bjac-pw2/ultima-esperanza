	...
	<div id="contenido">
		<div id="articulos">
			<div class="art">
				...
				<p>Todos las personas que cuenten con un celular, 
				Tablet, computadora, entre otros aparatos electrónicos que 
				cuente con internet podrá acceder al sistema de citas de la 
				Clínica ultima Esperanza.</p>
			</div>
			<div class="art">
