...
<body>
	...
	<div id="contenido">
		<div id="contenido-cont">
			<h2 class="ti">BJAC</h2>
	    	<p class="pa">Grupo formado para realizar el trabajo final del curso<br>
	    	Programacion Web 2 .</p>
	    	<h2 class="ti">Integrantes</h2>
	    	<p class="pa">
	    		-AVILA/CORDOVA, AARON WALTER<br>
	    		-PAUCAR/NUÑEZ, JOSEPH CLINTHON<br>
	    		-MAMANI/MACHACA, CRISTIAN DAVID<br>
