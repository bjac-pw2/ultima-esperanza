	...
	<div id="contenido">
		<div id="articulos">
			<div class="art">
				...
				<p>Antes de esta web App la Clínica Ultima Esperanza  
				contaba con un sistema de citas vía telefónico, el cual era incómodo para los pacientes.</p>
			...
			<div class="art">
				...
				<p> Con el nuevo sistema los pacientes están cómodos
				 por la sencillez con la cual pueden adquirir una cita. </p>
				<h5>MAYOR COMIDAD</h5>
