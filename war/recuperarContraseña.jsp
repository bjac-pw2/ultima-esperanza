...
<body>
	...
	<div id="contenido">
		<div id="contenido-cont">
			<h2 class="ti">Recuperar Contraseña</h2>
	    	<p class="pa">Si Ud. perdio su contraseña, por favor llene el formulario de abajo, ingrese su nombre de usuario,<br>
	    	y se le enviara asu correo su nueva contraseña.</p>
			<div class="entrada">
				<div class="tituloEntrada">RECUPERAR CONTRASEÑA</div>
				<div class="cuerpoEntrada">
					<div id="centrarForm">
						<form action="enviarPassword" method="get">
							<span class="lf">Ingrese su Nombre de Usuario</span> 
							<input type="text" name="dni"placeHolder="Ejemplo: 00407070">
